...
ann.fit(xtest, ytest, max_iter=300, lr=0.15, optimizer="Adam", method="Finite Difference",
        epsilon=0.001)
loss1 = ann.loss_test
...
ann.fit(xtest, ytest, max_iter=300, lr=0.15, optimizer="Adam", method="Gradient")
loss2 = ann.loss_test
